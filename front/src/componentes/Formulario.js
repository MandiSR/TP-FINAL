...
//     //     setInputProduct(prevState => ({
//     //         ...prevState,
//     //         [name]: name === 'fotoProducto' ? files[0] : value
//     //     }));
//     // };
...
//                 setInputProduct(prevState => ({
//                     ...prevState,
//                     [name]: reader.result // Almacena la imagen en base64
//                 }));
//             };
...
//         try {
//             const response = await axios.post('http://localhost:3001/api/producto/guardar', formData, {
//                 headers: {
//                     'Content-Type': 'multipart/form-data',
//                 },
//             });
